package com.timzaak.api.huobi.api.http

import java.net.URLEncoder
import java.time.{LocalDateTime, ZoneId}

import com.timzaak.api.huobi.S
import com.timzaak.api.huobi.api.http.entity.DepthType.DepthType
import com.timzaak.api.huobi.api.http.request.{KlineRequest, OrderPlaceRequest}
import com.timzaak.api.huobi.api.http.response.{DepthResponse, KlineResponse, TradeResponse}
...
trait HttpHuobiApi extends Http4SRequestWrapper with JsonHelperWithDoubleMode {
