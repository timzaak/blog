...
import com.timzaak.api.huobi.api.ws.HuobiWebSocketListener
...
class HuobiWSClient(listener: HuobiWebSocketListener) extends ClassSlf4j with JsonHelperWithDoubleMode{self =>
