package com.timzaak.coin.huobi.api.http
...
import com.timzaak.coin.huobi.api.http.request.{KlineRequest, OrderPlaceRequest}
import com.timzaak.coin.huobi.api.http.response.{DepthResponse, KlineResponse, TradeResponse}
